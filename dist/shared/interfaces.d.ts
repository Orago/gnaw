...
export type Statement = CustomStatement | {
...
export type StatementOf<T extends StatementType> = Extract<Statement, {
    type: T;
}>;
...
export type Expression = CustomExpression | {
...
export type ExpressionOf<T extends ExpressionType> = Extract<Expression, {
    type: T;
}>;
